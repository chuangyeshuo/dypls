...
3.  在指定回执消息类型的页签中，开启指定模式。
    -   **MNS消息队列消费模式**示通过MNS的Queue模型来接收回执消息。
        ...
        2.  单击**新建队列**。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134210/155228484839886_zh-CN.png)

        3.  设置队列名称并勾选关联的号码池。

            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134210/155228484839887_zh-CN.png)
    ...
    -   **HTTP批量推送模式**表示通过 HTTP POST 方式发送消息到指定的 Web URL。
        ...
        3.  填写接收地址，并单击**保存**。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134210/155228484839888_zh-CN.png)
